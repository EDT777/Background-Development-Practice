  ...
  <div class="nav-div">
    <div class="row justify-content-between" >
      ...
      <div class="col-md-1" style="text-align: center;padding: 20px;">
        ...
        <@shiro.authenticated>
            <@shiro.principal property="username"/> ,你好
        </@shiro.authenticated>
        <@shiro.notAuthenticated>
            <a href="/login.html">亲,请你登陆</a>
        </@shiro.notAuthenticated>
      </div>
...
<div class="body">
  <div class="banner">
    ...
    <img height="540px" width="960px" src="/img/system/banner.png"/>
  </div>
</div>
<div class="footer">
  <div class="row">
      ...
      <form id="appointmentForm" method="post" action="/appointment/save">
        <div class="modal-body">
          ...
          <div class="input-group">
            ...
            <select class="form-control"  placeholder="请选择预约业务" id="category" name="category.id">
          ...
          <div class="input-group">
            ...
            <input  class="form-control input-date-hm"  placeholder="请选择预约时间" name="appointmentTime">
          </div>
          <br/>
          <div class="input-group">
