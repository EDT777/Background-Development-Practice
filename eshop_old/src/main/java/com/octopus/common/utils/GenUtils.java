...
import com.octopus.common.config.Constant;
import com.octopus.common.domain.ColumnDO;
import com.octopus.common.domain.TableDO;
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (Map<String, Object> column : columns) {
            ...
            if(column.get("columnLength")!=null){
            	int len  =Integer.parseInt(column.get("columnLength") +"");
            	columnDO.setColumnLength(len);
            }else{
            	columnDO.setColumnLength(0);
            }
