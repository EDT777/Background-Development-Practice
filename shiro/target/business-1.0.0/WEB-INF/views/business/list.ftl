                ...
                <div style="margin: 20px 0px 0px 10px">
                    <form class="form-inline" id="searchForm" action="/business/list" method="post">
                        <input type="hidden" name="currentPage" id="currentPage" value="1">
                               ...
                               <div class="form-group">
                                    <label>经营日期查询：</label>
                                    <input placeholder="请输入开始日期" type="text" class="form-control input-date"
                                           name="startDate" value="${(qo.startDate?string('yyyy-MM-dd'))!}"/> -
                                    <input placeholder="请输入结束日期" type="text" class="form-control input-date"
                                ...
                                <a href="/business/input.do" class="btn btn-success">
                    ...
                    <tbody>
                        <#list pageInfo.list as business>
                            <tr>
                                ...
                                <td>${business.mainStore?string("<span class='text-success'>总店</span>","分店")}</td>
                                <td>
