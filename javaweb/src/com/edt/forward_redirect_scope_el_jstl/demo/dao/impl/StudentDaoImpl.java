package com.edt.forward_redirect_scope_el_jstl.demo.dao.impl;
...
public class StudentDaoImpl implements IStudentDao {
    ...
    public void insert(Student stu) {
        SqlSession session = new SqlSessionFactoryBuilder().build(Thread.currentThread().getContextClassLoader().getResourceAsStream("mybatis-config2.xml")).openSession();
