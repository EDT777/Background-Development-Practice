...
/**
 * A DTO for the {@link com.octopus.vip1.domain.InfoItemVisitDataStat} entity.
 */
@ApiModel(description = "信息流项目访问的统计信息.\n@author hw")
public class InfoItemVisitDataStatDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        InfoItemVisitDataStatDTO infoItemVisitDataStatDTO = (InfoItemVisitDataStatDTO) o;
        if (infoItemVisitDataStatDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), infoItemVisitDataStatDTO.getId());
    }
    ...
    public String toString() {
        return "InfoItemVisitDataStatDTO{" +
            "id=" + getId() +
