    ...
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span v-text="$t('global.title')" class="navbar-title">vip1</span> <span class="navbar-version">{{version}}</span>
            </b-navbar-brand>
        </div>
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/info-stream-item">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.infoStreamItem')">InfoStreamItem</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/relative-goods-item">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.relativeGoodsItem')">RelativeGoodsItem</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/reply">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.reply')">Reply</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/author">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.author')">Author</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/resource-item">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.resourceItem')">ResourceItem</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/info-item-visit-data">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.infoItemVisitData')">InfoItemVisitData</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/info-item-visit-data-stat">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.infoItemVisitDataStat')">InfoItemVisitDataStat</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/reply-visit-data-stat">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.replyVisitDataStat')">ReplyVisitDataStat</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/author-favour-data">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.authorFavourData')">AuthorFavourData</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/stream-item-star-data">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.streamItemStarData')">StreamItemStarData</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/user-content-collection">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.userContentCollection')">UserContentCollection</span>
                    </b-dropdown-item>
